      ...
      <main className='p-8 m-0 w-full sm:p-9 md:py-16 md:px-64'>
        ...
        <div className='pt-8 pb-16'>
          <div className='section-class w-full h-full px-4 md:px-12 py-6 rounded-lg'>
            <h1 className='text-5xl text-white text-left font-extrabold pb-4'>Enter Number:</h1>
            ...
            <div className='flex justify-end'><button className="bg-white hover:bg-blue-700 text-black hover:text-white font-semibold py-2 px-4 rounded">Check</button></div>
          </div>
        </div>
